...
import { Users, Smartphone, Target } from 'lucide-react';
        ...
        <div className="landing">
            ...
            <section className="landing__features">
                ...
                <div className="landing__features-grid">
                    ...
                    <div className="landing__feature-card">
                        <div className="landing__feature-icon"><Users size={32} /></div>
                        <h3>Expert Staff</h3>
                        <p>Our trained consultants are ready to answer all your questions</p>
                    </div>
                    <div className="landing__feature-card">
                        <div className="landing__feature-icon"><Smartphone size={32} /></div>
                        <h3>Digital Queue</h3>
                        <p>Modern ticketing system with real-time status updates</p>
                    </div>
                    <div className="landing__feature-card">
                        <div className="landing__feature-icon"><Target size={32} /></div>
                        <h3>Personalized</h3>
